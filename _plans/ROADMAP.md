...
→ **2026-05-04 (Nacht):** **Pilzling-Go-Live-Aufbau komplett.** Master-Plan: [`2026-05-04-pilzling-go-live.md`](2026-05-04-pilzling-go-live.md). Alle Phasen A-J durchgebaut: Schema v2, Widget-Komplett-Refactor (mit Aggregat, Avatar, Datum, Plattform-Icon, Pfeil-Nav, CTA, Footer), Admin-Pages reviews.php, replies.php, analytics.php, widget-config.php (mit Live-Preview-Iframe), qr.php (Bewertungslink + QR-Generator via QuickChart.io), shops.php (Multi-Tenant-Switch), settings.php (3 Tabs), und public/feedback.php (Bewertungs-Landing-Page). Alle Hub-Tile-Links auf dem Dashboard funktionieren — keine 404 mehr. **Noch erforderlich:** schema_v2.sql via phpMyAdmin einspielen.
